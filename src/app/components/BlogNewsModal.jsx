...
export default function BlogNewsModal() {
  ...
  useEffect(() => {
    ...
    const currentArticlesBatchId = "articles-2025-04-05";
                  ...
                  <div className="space-y-4 mb-6">
                    <Link href="/blog/dix-septieme-article" className="block">
                      <div className="bg-purple-50 p-4 rounded-lg hover:bg-purple-100 transition-colors">
                        <h4 className="font-semibold text-purple-700 mb-1">Rituel de Renouveau Printanier</h4>
                    ...
                    <Link href="/blog/dix-septieme-article" className="block">
                      <div className="bg-indigo-50 p-4 rounded-lg hover:bg-indigo-100 transition-colors">
                        <h4 className="font-semibold text-indigo-700 mb-1">LA JOURNEE Type pour se protéger et se libérer</h4>
                        <p className="text-gray-600 text-sm mb-2">Une routine de 5 minutes par jour pour éliminer les énergies négatives.</p>
                      </div>
                    </Link>
                  </div>
