...
export default function BlogNewsModal() {
  ...
  useEffect(() => {
    ...
    const currentArticlesBatchId = "articles-2026-05-lune-sagittaire-gemeaux-solitude";
              ...
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-purple-100">
                ...
                <div className="p-6">
                  <p className="text-gray-600 mb-4">
                    Trois nouveaux articles pour t'ouvrir, respirer et te retrouver :
                  </p>
                  
                  <div className="space-y-4 mb-6">
                    <Link href="/blog/soixante-treizieme-article" className="block">
                      <div className="bg-amber-50 p-4 rounded-lg hover:bg-amber-100 transition-colors border border-amber-200">
                        <h4 className="font-semibold text-amber-700 mb-1">🌕✨ Pleine Lune du 31 Mai 2026 en Sagittaire</h4>
                        <p className="text-gray-600 text-sm mb-2">Une lune d'expansion, liberté et vision. Rituel "J'Ouvre Mon Horizon Intérieur".</p>
                      </div>
                    </Link>
                    
                    <Link href="/blog/soixante-quatorzieme-article" className="block">
                      <div className="bg-sky-50 p-4 rounded-lg hover:bg-sky-100 transition-colors border border-sky-200">
                        <h4 className="font-semibold text-sky-700 mb-1">🌑✨ Nouvelle Lune du 15 Juin 2026 en Gémeaux</h4>
                        <p className="text-gray-600 text-sm mb-2">Une lune de légèreté et clarté mentale. Rituel "Je Respire la Simplicité".</p>
                      </div>
                    </Link>

                    <Link href="/blog/soixante-quinzieme-article" className="block">
                      <div className="bg-violet-50 p-4 rounded-lg hover:bg-violet-100 transition-colors border border-violet-200">
                        <h4 className="font-semibold text-violet-700 mb-1">🌙🤍 La solitude sacrée : se retrouver au lieu de s'isoler</h4>
                        <p className="text-gray-600 text-sm mb-2">La solitude n'est pas l'isolement. C'est un retour à toi, plein et précieux.</p>
                      </div>
                    </Link>
                  </div>
