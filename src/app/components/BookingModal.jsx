...
// Créneaux horaires temporaires (à remplacer par l'intégration Google Calendar)
const DEFAULT_SLOTS = [
  "09:00",
  "10:00",
  "11:00",
...
export default function BookingModal({ isOpen, onClose, service }) {
  ...
  // Simuler les créneaux disponibles (à remplacer par l'API Google Calendar)
...
{step === 3 && (
  <div className="space-y-6">
    ...
    <div className="p-4 bg-purple-50 rounded-xl">
      <h4 className="font-medium text-gray-900 mb-3">Résumé de votre réservation</h4>
    ...
    <div className="flex gap-3 pt-4">
      ...
      <button
        ...
        className="w-full py-3 bg-purple-600 text-white rounded-xl disabled:opacity-50 hover:bg-purple-700"
      >
